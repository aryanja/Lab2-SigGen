...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vdly__sigdelay__DOT__wr_addr = vlSelfRef.sigdelay__DOT__wr_addr;
    if (vlSelfRef.rst) {
        vlSelfRef.__Vdly__sigdelay__DOT__wr_addr = 0U;
    } else if (vlSelfRef.wr) {
        vlSelfRef.__Vdly__sigdelay__DOT__wr_addr = 
            (0x1ffU & ((IData)(1U) + (IData)(vlSelfRef.sigdelay__DOT__wr_addr)));
    }
}
...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*7:0*/ __VdlyVal__sigdelay__DOT__signal_ram__DOT__ram_array__v0;
    __VdlyVal__sigdelay__DOT__signal_ram__DOT__ram_array__v0 = 0;
    SData/*8:0*/ __VdlyDim0__sigdelay__DOT__signal_ram__DOT__ram_array__v0;
    __VdlyDim0__sigdelay__DOT__signal_ram__DOT__ram_array__v0 = 0;
    CData/*0:0*/ __VdlySet__sigdelay__DOT__signal_ram__DOT__ram_array__v0;
    __VdlySet__sigdelay__DOT__signal_ram__DOT__ram_array__v0 = 0;
    // Body
    __VdlySet__sigdelay__DOT__signal_ram__DOT__ram_array__v0 = 0U;
    if (vlSelfRef.wr) {
        __VdlyVal__sigdelay__DOT__signal_ram__DOT__ram_array__v0 
            = vlSelfRef.mic_signal;
        __VdlyDim0__sigdelay__DOT__signal_ram__DOT__ram_array__v0 
            = vlSelfRef.sigdelay__DOT__wr_addr;
        __VdlySet__sigdelay__DOT__signal_ram__DOT__ram_array__v0 = 1U;
    }
    if (vlSelfRef.rd) {
        vlSelfRef.delayed_signal = vlSelfRef.sigdelay__DOT__signal_ram__DOT__ram_array
            [(0x1ffU & ((IData)(vlSelfRef.sigdelay__DOT__wr_addr) 
                        - (IData)(vlSelfRef.offset)))];
    }
    if (__VdlySet__sigdelay__DOT__signal_ram__DOT__ram_array__v0) {
        vlSelfRef.sigdelay__DOT__signal_ram__DOT__ram_array[__VdlyDim0__sigdelay__DOT__signal_ram__DOT__ram_array__v0] 
            = __VdlyVal__sigdelay__DOT__signal_ram__DOT__ram_array__v0;
    }
}
...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.sigdelay__DOT__wr_addr = vlSelfRef.__Vdly__sigdelay__DOT__wr_addr;
}
